    ...
    <section className="space-y-5">
      ...
      <div className="card flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          ...
          className={`flex items-center gap-3 rounded-lg border px-4 py-2.5 text-sm font-semibold shadow-sm transition-colors cursor-pointer ${
            autoEnabled
        ...
        >
          <span
            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
              autoEnabled ? "bg-emerald-900/40" : "bg-slate-300"
            }`}
          >
            <span
          ...
          {autoEnabled ? "Auto reminders: ON" : "Turn on auto reminders"}
        </button>
      </div>
